...
Una volta ricavate le regioni simili \`e possibile calcolare la disparity map, la quale \`e ottenuta applicando la SAD a tutti i pixel dell'immagine nei quali si \`e ricavata il valore di disparit\`a pi\`u basso.
