...
Lo sviluppo della distribuzione \`e stato parallelo allo sviluppo dell'applicazione. Mano a mano che si aggiungevano componenti aumentavano i requisiti dell'applicativo e di conseguenza venivano aggiunte parti alla distro.

Inizialmente, si \`e partiti aggiungendo solamente OpenCV all'immagine. Questo perch\`e bastava per supportare l'applicativo del Passenger Counter a sottrazione del background. Poich\`e in assenza di ulteriori restrizioni si \`e potuto installare l'ultima versione rilasciata della libreria: la 3.2.
