...
% TODO: Cercare e capire la tecnica usata da Opencv per il rilevamento dei contorni
\subsection{Algoritmo per il rilevamento dei contorni}
Il codice usa l'algoritmo descritto in Suzuki, S. and Abe, K., Topological Structural Analysis of Digitized Binary Images by Border Following. CVGIP 30 1, pp 32-46 (1985).

\subsection{Kernel del codice del PCN a sottrazione del background}

\begin{lstlisting}[language=C++, caption=Kernel del codice del Passenger Counter a sottrazione del background]
VideoCapture cap;
