...
\subsection{Analisi del codice del programma}
Suddivideremo il codice in quattro sezioni principali:
\begin{enumerate}
\item Estrazione degli oggetti in movimento.
\item Rilevamento e tracking degli oggetti di nostro interesse.
\item Struttura per la rappresentazione delle entit\`a passeggeri.
