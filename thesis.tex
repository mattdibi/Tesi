...
\begin{center}
	...
	Acquisizione video & Webcam \\ \hline
...
\item Compatibilit\`a: anche se inizialmente non era previsto l'impiego delle telecamere RealSense, la board Xilinx non sarebbe potuta essere compatibile con queste ultime.
\end{itemize}
...
In questa sezione tratteremo la prima versione realizzata del contatore di passeggeri. Questa prima versione non faceva uso delle telecamere RealSense e presentava alcune criticit\`a che vedremo nel seguito. \`E per\`o stata fondamentale per la versione successiva, facente uso delle telecamere RealSense.
