...
Lo stack software completo di questa versione della distribuzione \`e riportato in figura \ref{fig:SWStack} ed \`e la versione finale del progetto.

%% Interruzione di pagina
\newpage

\subsection{File di configurazione}
Qui di seguito riportiamo i file principali di configurazione del build system per la realizzazione della distribuzione.
...
Vediamo ora nel dettaglio il significato di questi metadati:

\begin{itemize}
\item MACHINE: \`e la target machine per la build. Nel nostro caso stiamo costruendo una distribuzione per una architettura Intel 64-bit.
\item DISTRO: 
\end{itemize}
