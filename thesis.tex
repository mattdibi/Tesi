...
% \begin{figure}[h!]
%   \centering
%   \includegraphics[scale=0.5]{PCNMano1.png}
%   \caption{Risultato tracciamento sperimentale PCN. Frame precedente all'attraversamento.}
%   \label{fig:PCNMano1}
% \end{figure}
% 
% \begin{figure}[h!]
%   \centering
%   \includegraphics[scale=0.5]{PCNMano2.png}
%   \caption{Risultato tracciamento sperimentale PCN. Primo attraversamento.}
%   \label{fig:PCNMano2}
% \end{figure}
...
Qui di seguito \`e riportato un confronto sui tempi di esecuzione delle funzioni principali delle due implementazioni del contatore. Per il confronto si \`e usata la telecamera SR300 e la webcam poich\`e hanno la stessa risoluzione e lo stesso framerate.
...
\noindent \underline{Setup esperimento:}
...
\noindent \underline{Risultati attraversamenti singolo passeggero}
...
\noindent \underline{Risultati attraversamenti di pi\`u passeggeri}
...
\noindent \underline{Risultati incrocio di pi\`u passeggeri}
...
La versione con telecamere ad infrarossi invece, ancora una volta, si conferma molto precisa.
...
\begin{figure}[h!]
  \centering
\includegraphics[width=0.9\textwidth]{SoftwareStackDiag.png}
