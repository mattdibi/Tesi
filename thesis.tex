...
\usepackage{capt-of}
\graphicspath{ {img/Introduzione/} {img/ContestoTecnologico/1_PCNEurotech/} {img/ContestoTecnologico/2_TecnTesi/} {img/CorpoTesi/1_AmbientiLavoro/} {img/CorpoTesi/2_PCNBackSub/} {img/CorpoTesi/3_RSPCN/} {img/CorpoTesi/4_Confronto/}}
...
\begin{itemize}
\item BPCN: Passenger Counter a sottrazione del background.
\item RPCN: Passenger Counter con telecamere RealSense.
\end{itemize}
...
\begin{minipage}[b]{8.5cm}
  ...
  \caption{Dettaglio tracking ombra BPCN}
  \label{fig:ombraPCN}
\end{minipage}
\ \hspace{2mm} \hspace{3mm} \
\begin{minipage}[b]{8.5cm}
 \centering
  ...
  \caption{Dettaglio tracking ombra RPCN}
