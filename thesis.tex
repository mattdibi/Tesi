...
In questa sezione tratteremo la prima versione realizzata del contatore di passeggeri. Questa prima versione non faceva uso delle telecamere RealSense e presentava alcune criticit\`a che vedremo nel seguito ma \`e stata fondamentale per lo sviluppo della versione successiva, in quanto ne condivide gran parte del codice e concetti fondamentali. 
