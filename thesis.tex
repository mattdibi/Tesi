...
\begin{verbatim}
$INSTALL\_DIR/poky/meta-java/recipes-core/openjdk/openjdk-8-common.inc
\end{verbatim}
...
Qui di seguito \`e riportato uno screenshot della schermata tipica di funzionamento del programma su una macchina host. Il programma si trova in modalit\`a di esecuzione senza argomenti e sono stati visualizzati lo stream a colori e abilitata la calibrazione dei settaggi del contatore.
...
\item \verb|p|: Selezione i preset per la telecamera da utilizzare. I preset sono delle impostazioni della telecamera ad infrarossi che ne modificano il comportamento permettendo di impostare l'esposizione, la precisione ecc.
