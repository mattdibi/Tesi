...
\begin{enumerate}
\item L'inizializzazione del background: dove viene creato il primo modello dello sfondo (BG Model).
...
Nel caso dell'applicazione del Passenger Counter le regioni di interesse, o blob, saranno i passeggeri che si vuole tracciare all'interno del raggio visivo della telecamera. Per andare a rilevare questi ultimi si \`e usata la funzione \verb|findContours()|.
