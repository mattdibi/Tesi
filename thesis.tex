...
\subsubsection{Step 1: Clone needed repositories}
...
\subsubsection{Step 2: Build environment}

\begin{lstlisting}[language=bash]
$ source oe-init-build-env
\end{lstlisting}

\subsubsection{Step 3: Aggiungo layer}
...
\noindent Build the image:

\begin{lstlisting}[language=bash]
$ bitbake core-image-sato
\end{lstlisting}

\noindent Output files will be available in 

\begin{verbatim}
$HOME/poky/build/tmp/deploy/images/intel-corei7-64/ folder.
\end{verbatim}

%% Interruzione di pagina
\newpage

\noindent Build the cross-compiler installer:
