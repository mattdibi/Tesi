...
La piattaforma target sarebbe stata una Avnet Zedboard. Specifiche tecniche:

\begin{center}
	\begin{tabular}{|c|c|}
	\hline
    ZYNQ-7000 SOC XC7Z020-CLG484-1 & Dual ARM Cortex-A9 MPCore \\ \hline
    Memoria & 512 MB DDR3 \\ \hline
    Espanzione & FMC (Low Pin Count) (5) Pmod headers (2x6) \\ \hline
    Video & HDMI output (1080p60 + audio), VGA connector \\
    \hline
	\end{tabular}
\end{center}
...
\begin{center}
	\begin{tabular}{|c|c|}
	\hline
	Hardware & Eurotech ReliGate 20-25 \\ \hline
