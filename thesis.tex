...
\item Per ogni contorno completo rilevato dalla funzione eseguiamo le seguenti operazioni:
    ...
    \item Di questo rettangolo rileviamo il centro \verb|mc| grazie ad una semplice operazione geometrica.
    ...
    \end{enumerate}
\end{enumerate}
L'informazione fondamentale per il resto dell'algoritmo \`e data dalla posizione del centro di questo rettangolo, contenuto nella variabile \verb|mc|, che rappresenter\`a la posizione dei passeggeri all'interno del raggio visivo della telecamera.
