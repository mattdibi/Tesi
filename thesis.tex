...
\item Attraversamenti: per entrambe le versioni sono stati eseguiti 15 attraversamenti della soglia e raccolti di dati del conteggio. Inoltre si \`e testato il funzionamento con l'attraversamento di pi\`u passeggeri contemporaneamente.
\end{itemize}

\noindent Risultati attraversamenti singolo passeggero:
...
\noindent Risultati attraversamenti di pi\`u passeggeri:

\begin{figure}[h!]
\begin{minipage}[b]{8.5cm}
  \centering
  \includegraphics[width=8cm]{Attraversamento2PasseggeriPCN.png}
  \caption{Attraversamento multiplo BPC}
  \label{fig:AttrBPC}
\end{minipage}
\ \hspace{2mm} \hspace{3mm} \
\begin{minipage}[b]{8.5cm}
 \centering
  \includegraphics[width=8cm]{Attraversamento2PasseggeriRSPCN.png}
  \caption{Attraversamento multiplo RPC}
  \label{fig:AttrRPC}
\end{minipage}
\end{figure}

Anche in questa situazione la versione basata su sottrazione del background non \`e precisa. Fare affidamento sull'area per rilevare il passaggio di pi\`u persone contemporaneamente \`e alla base del problema e comporta un'altissima imprecisione.
