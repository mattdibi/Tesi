...
Per poter eseguire l'applicativo sulla piattaforma target \`e necessario solamente disporre dell'immagine della distribuzione Yocto e la toolchain generata con il progetto Yocto.
